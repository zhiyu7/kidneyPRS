...
#output_path = paste0(jindir,"collaboration/CKDPRS/output/c_LDpred/", trait_name)
...
Pvalthr = c(0.05,0.00000005) #0.05 #c(1,0.5,0.05,0.0005,0.000005,0.00000005)
